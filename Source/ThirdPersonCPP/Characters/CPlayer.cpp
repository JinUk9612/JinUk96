...
void ACPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("SubAciton", EInputEvent::IE_Pressed, this, &ACPlayer::OnDoSubAction);
	PlayerInputComponent->BindAction("SubAciton", EInputEvent::IE_Released, this, &ACPlayer::OffDoSubAction);
...
{
	State->SetIdleMode();
	if (!!Action->GetCurrentDataAsset() && Action->GetCurrentDataAsset()->GetEquipmentData().bLookForward == true)
	{
		bUseControllerRotationYaw = true;
		GetCharacterMovement()->bOrientRotationToMovement = false;
	}
...
void ACPlayer::End_Backstep()
{
	...
	if (!!Action->GetCurrentDataAsset() && Action->GetCurrentDataAsset()->GetEquipmentData().bLookForward == false)
	{
		bUseControllerRotationYaw = false;
		GetCharacterMovement()->bOrientRotationToMovement = true;
	}
